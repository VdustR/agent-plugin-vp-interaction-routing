...
const INVARIANTS = [
  ...
  [FIXTURE, /`--snapshot` from a fresh `see`.*`effect: unverifiable`.*capture-and-compare/s,
    "fixture must verify material Peekaboo effects and fresh coordinate snapshots"],
  [FIXTURE, /native file\s+or folder picker will take the foreground/s,
  ...
  [NATIVE, /`effect: unverifiable` is not evidence of success.*compare a follow-up capture/s,
    "material Peekaboo effects must have capture-and-compare readback"],
  [NATIVE, /`--snapshot` from a fresh `see` capture of that exact target window/s,
