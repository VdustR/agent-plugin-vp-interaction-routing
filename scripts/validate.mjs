...
const INVARIANTS = [
  ...
  [SKILL, /End task-owned Computer Use sessions after success, failure, cancellation, or\s+handoff/s,
    "skill must end task-owned Computer Use sessions on every exit path"],
  ...
  [NATIVE, /success, failure, cancellation, or\s+handoff.*confirm that the session ended/s,
